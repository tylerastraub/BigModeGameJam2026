...
@warning_ignore("unused_signal")
signal checkForPlayerHighScore(level: int, score: int, rank: String)
...
@warning_ignore("unused_signal")
signal levelSelectButtonHovered(is_hovering: bool, rank_reqs: Dictionary[String, int], high_score: int, high_rank: String)
@warning_ignore("unused_signal")
signal restartLevel()
@warning_ignore("unused_signal")
